...
const userTabs = [
  { path: '/ride', icon: Home, label: 'Home' },
  { path: '/ride/tracking', icon: MapPin, label: 'Tracking' },
  { path: '/ride/history', icon: Clock, label: 'History' },
  { path: '/ride/profile', icon: User, label: 'Profile' },
];
